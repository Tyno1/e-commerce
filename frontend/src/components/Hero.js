...
export default function Hero() {
  return (
    <div className="hero w-full min-h-[100vh] md:h-[95vh] px-4 md:px-10 overflow-hidden pt-40 md:pt-32 mb:20 sm:mb-40 flex flex-col md:flex-row items-center md:justify-between">
      <div className="hero-text w-[100%] md:w-[60%] lg:w-[40%] flex flex-col items-left">
        <p className="text-teal-800 dark:text-orange-300">
          LONAX & CO brings to you
        </p>
      ...
      <div className="rounded-xl w-full h-60 md:hidden mt-10">
        <img
