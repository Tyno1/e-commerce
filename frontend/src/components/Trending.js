  ...
  return (
    <div className="trending w-full my-20 p-10">
      <div className="flex flex-col items-center">
        <h3 className="text-5xl font-bold text-teal-950 text-center dark:text-orange-300">Featured Products</h3>
        <p className="text-teal-950 text-center dark:text-orange-300">Find products that are getting all the attention !!</p>
