        ...
        <div className="flex justify-between flex-col">
          <div className="p-10 dark:text-teal-50 text-teal-900">
            <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight">
              Get In <span className="dark:text-orange-300">Touch</span>
            </h3>
            <p className="mt-4 leading-7 text-gray-500 dark:text-gray-200 text-justify">
          ...
          <form className="md:col-span-8 p-10">
            <div className="flex flex-wrap -mx-3 mb-6">
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                <label
                  className="block uppercase tracking-wide text-gray-500 dark:text-gray-200 text-xs font-bold mb-2"
                  for="grid-first-name"
                >
                  First Name
                </label>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              ...
              <div className="flex justify-between w-full px-3">
                <div className="md:flex md:items-center">
                  <label className="block text-gray-500 dark:text-gray-200  font-bold">
                    <input className="mr-2 leading-tight" type="checkbox" />
                    <span className="text-sm">Send me your newsletter!</span>
                  </label>
                </div>
                <button
                  className="hidden items-center border-2 border-orange-300 justify-center rounded-lg bg-teal-900 px-3 py-2 text-sm font-semibold text-orange-200 shadow-sm ring-1 ring-inset ring-orange-300 transition-all duration-150 hover:bg-teal-700 sm:inline-flex"
                  type="submit"
                >
                  Send Message
                </button>
